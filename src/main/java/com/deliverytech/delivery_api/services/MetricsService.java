...
public class MetricsService {
    ...
    public MetricsService(MeterRegistry meterRegistry) {
        ...
        // Inicializar gauges
        Gauge.builder("delivery.usuarios.ativos")
                .description("Número de usuários ativos")
                .register(meterRegistry, usuariosAtivos, AtomicInteger::get);

        Gauge.builder("delivery.produtos.estoque")
                .description("Produtos em estoque")
                .register(meterRegistry, produtosEmEstoque, AtomicLong::get);
    }
