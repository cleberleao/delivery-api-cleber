...
-- Inserir clientes
INSERT INTO cliente (nome, email, telefone, endereco, cpf, data_cadastro, ativo) VALUES
('João Silva', 'joao@email.com', '(11) 99999-1111', 'Rua A, 123 - São Paulo/SP', "11122233395", CURRENT_TIMESTAMP, 1),
('Maria Santos', 'maria@email.com', '(11) 99999-2222', 'Rua B, 456 - São Paulo/SP', "11122233395", CURRENT_TIMESTAMP, 1),
('Pedro Oliveira', 'pedro@email.com', '(11) 99999-3333', 'Rua C, 789 - São Paulo/SP', "11122233395", CURRENT_TIMESTAMP, 1);

-- Inserir restaurantes
INSERT INTO restaurante (nome, categoria, endereco, cep, telefone, taxa_entrega, avaliacao, ativo) VALUES
('Pizzaria Bella', 'Italiana', 'Av. Paulista, 1000 - São Paulo/SP', '31360000', '(11) 3333-1111', 5.00, 4.5, 1),
('Burger House', 'Hamburgueria', 'Rua Augusta, 500 - São Paulo/SP', '31360000', '(11) 3333-2222', 3.50, 4.2, 1),
('Sushi Master', 'Japonesa', 'Rua Liberdade, 200 - São Paulo/SP', '31360000', '(11) 3333-3333', 8.00, 4.8, 1);
...
INSERT INTO pedido (numero_pedido, data_pedido, status, valor_total, observacoes, cliente_id, restaurante_id, endereco_entrega, cep, taxa_entrega) VALUES
('PED1234567890', CURRENT_TIMESTAMP, 'PENDENTE', 54.80, 'Sem cebola na pizza', 1, 1, 'Rua A, 123 - São Paulo/SP', '31360000', 5.00),
('PED1234567891', CURRENT_TIMESTAMP, 'CONFIRMADO', 41.80, '', 2, 2, 'Rua B, 456 - São Paulo/SP', '31360000', 3.50),
('PED1234567892', CURRENT_TIMESTAMP, 'ENTREGUE', 78.80, 'Wasabi à parte', 3, 3, 'Rua Liberdade, 200 - São Paulo/SP', '31360000', 8.00);
